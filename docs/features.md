...
| 29 | WebDAV backup and restore                                     | Settings/*   | Medium   | IN PROGRESS | PR #128 — full data collector/restorer + BackupViewModel + WebDAVSettingsView backup section + integration test. 99 unit tests passing. Awaiting device verification before DONE. |
